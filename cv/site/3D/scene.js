...
audioLoader9.load('./assets/sounds/rain.mp3', function (buffer) {
...
//glassNorm = new THREE.TextureLoader().load( './assets/textures/glassN.jpg' );
...
loader.load(
	'./assets/obj/pool/tarp2.obj', function (object) {

		object.traverse(function (child) { child.castShadow = true; });
		object.traverse(function (child) { child.receiveShadow = true; });

		tarpTexture = new THREE.TextureLoader().load('./assets/textures/pool/tarpD.jpg');
		tarpTexture.wrapS = tarpTexture.wrapT = THREE.RepeatWrapping;
		tarpTexture.repeat.set(4, 4);

		tarpNorm = new THREE.TextureLoader().load('./assets/textures/pool/tarpN.jpg');
		tarpNorm.wrapS = tarpNorm.wrapT = THREE.RepeatWrapping;
		tarpNorm.repeat.set(4, 4);

		tarpSpec = new THREE.TextureLoader().load('./assets/textures/pool/tarpS.jpg');
...
loader.load(
	'./assets/obj/pool/pool.obj', function (object) {

		object.traverse(function (child) { child.castShadow = true; });
		object.traverse(function (child) { child.receiveShadow = true; });

		poolTexture = new THREE.TextureLoader().load('./assets/textures/pool/poolD.jpg');
		poolTexture.wrapS = poolTexture.wrapT = THREE.RepeatWrapping;
		poolTexture.repeat.set(5, 5);

		poolNorm = new THREE.TextureLoader().load('./assets/textures/pool/poolN.jpg');
		poolNorm.wrapS = poolNorm.wrapT = THREE.RepeatWrapping;
		poolNorm.repeat.set(5, 5);

		poolSpec = new THREE.TextureLoader().load('./assets/textures/pool/poolS.jpg');
...
loader.load(
	'./assets/obj/pool/ladder.obj', function (object) {

		object.traverse(function (child) { child.castShadow = true; });
		object.traverse(function (child) { child.receiveShadow = true; });

		ladderNorm = new THREE.TextureLoader().load('./assets/textures/pool/ladderN.jpg');
		ladderNorm.wrapS = ladderNorm.wrapT = THREE.RepeatWrapping;
		ladderNorm.repeat.set(40, 40);

		ladderSpec = new THREE.TextureLoader().load('./assets/textures/pool/ladderS.jpg');
...
loader.load(
	'./assets/obj/pool/ladder2.obj', function (object) {

		object.traverse(function (child) { child.castShadow = true; });
		object.traverse(function (child) { child.receiveShadow = true; });

		pool2Texture = new THREE.TextureLoader().load('./assets/textures/pool/poolD.jpg');
		pool2Texture.wrapS = pool2Texture.wrapT = THREE.RepeatWrapping;
		pool2Texture.repeat.set(2, 2);

		pool2Norm = new THREE.TextureLoader().load('./assets/textures/pool/poolN.jpg');
		pool2Norm.wrapS = pool2Norm.wrapT = THREE.RepeatWrapping;
		pool2Norm.repeat.set(2, 2);

		pool2Spec = new THREE.TextureLoader().load('./assets/textures/pool/poolS.jpg');
...
alphaDrop = new THREE.TextureLoader().load('./assets/textures/dropB.jpg')
